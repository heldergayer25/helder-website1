        ...
        <div id="section_home"></div>           
            <section>     
                <ul class="thumbs">
                    ...
                    <li><a href="#thumb2" class="thumbnail" style="background-image: url('imagens/portfolio/capa/cartoes-comemorativos.jpg')">
                        <h4>Cartões</h4><span class="description">Cartões Comemorativos</span></a>
                    </li>                    
                    <li>
                        <a href="#thumb3" class="thumbnail" style="background-image: url('imagens/portfolio/capa/desenho-tecnico.jpg')">
                        <h4>Desenhos Técnicos</h4><span class="description">Desenhos Técnicos</span></a>
                    </li>
                    <li>
                        <a href="#thumb4" class="thumbnail" style="background-image: url('imagens/portfolio/capa/estampa.jpg')">
                    ...
                    <li>
                        <a href="#thumb6" class="thumbnail" style="background-image: url('imagens/portfolio/capa/material-grafico.jpg')">
